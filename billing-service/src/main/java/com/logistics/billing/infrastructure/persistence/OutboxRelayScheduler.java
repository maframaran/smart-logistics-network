...
class OutboxRelayScheduler {
    ...
    private static final Map<String, Class<? extends DomainEvent>> EVENT_TYPES = Map.of(
            "InvoiceGenerated", InvoiceGenerated.class,
            "InvoicePaid", InvoicePaid.class
    );
    ...
    OutboxRelayScheduler(OutboxJpaRepositoryPort outboxJpa, BillingEventPublisher publisher, ObjectMapper objectMapper) {
