...
class OutboxRelayScheduler {
    ...
    private static final Map<String, Class<? extends DomainEvent>> EVENT_TYPES = Map.of(
            "DriverRegistered", DriverRegistered.class,
            "DriverStatusChanged", DriverStatusChanged.class
    );

    private final OutboxJpaRepositoryPort outboxJpa;
    private final DriverEventPublisher publisher;
    private final ObjectMapper objectMapper;

    OutboxRelayScheduler(OutboxJpaRepositoryPort outboxJpa, DriverEventPublisher publisher, ObjectMapper objectMapper) {
