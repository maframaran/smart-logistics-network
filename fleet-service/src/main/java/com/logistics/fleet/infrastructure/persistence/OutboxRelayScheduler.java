...
class OutboxRelayScheduler {
    ...
    private static final Map<String, Class<? extends DomainEvent>> EVENT_TYPES = Map.of(
            "VehicleRegistered", VehicleRegistered.class,
            "VehicleStatusChanged", VehicleStatusChanged.class
    );
    ...
    OutboxRelayScheduler(OutboxJpaRepositoryPort outboxJpa, VehicleEventPublisher publisher, ObjectMapper objectMapper) {
